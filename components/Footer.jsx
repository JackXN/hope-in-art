  ...
  <Button fontSize='12px'>Submit</Button>
    ...
    <Box
      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <Box display='flex' flexDirection={['column', 'column', 'column', 'row']} justifyContent='space-evenly'>
          <Stack align={'flex-start'} display='none'>
            <ListHeader>Product</ListHeader>
            <Link href={'#'}>Overview</Link>
            <Stack direction={'row'} align={'center'} spacing={2}>
              <Link href={'#'}>Artist Submissions</Link>
              <Tag
                size={'sm'}
          ...
          <Stack display='none ' align={'flex-start'}>
            <ListHeader display='none'>Follow Us</ListHeader>
    ...
    <Image src='./HartLogo.png'/>
        ...
        <Text pt={6} fontSize={'sm'} textAlign={'center'}>
          © 2023 The Hope In Art Association LLC. All rights reserved
        </Text>
      </Box>
    </Box>
    </Box>
