...
const Panel = () => {
  ...
  <div class="antialiased max-w-6xl mx-auto my-12  px-8" data-aos='slide-up' data-aos-duration='2000' data-aos-delay='20'>
    ...
    <div class="relative block md:flex items-center">
      <div class="w-full md:w-1/2 relative z-1 bg-gray-100 rounded shadow-lg overflow-hidden">
        <div class="text-lg font-medium text-blue-500 uppercase p-8 text-center border-b border-gray-200 tracking-wide">Sign Up For Our Classes</div>
        ...
        <div class="flex justify-center mt-3">
          <ul>
            ...
            <li class="flex items-center mt-3">
              ...
              <span class="text-gray-700 text-lg ml-3">Consult With One Of Our Team Members</span>
            </li>
            <li class="flex items-center mt-3">
              <div class="bg-green-200 rounded-full p-2 fill-current text-green-700">
      ...
      <div class="w-full md:w-1/2 relative z-0 px-8 md:px-0 md:py-16">
        <div class="bg-blue-900 text-white rounded-b md:rounded-b-none md:rounded-r shadow-lg overflow-hidden">
          <div class="text-lg font-medium uppercase p-8 text-center border-b border-blue-800 tracking-wide">Join Us</div>
          <div class="text-center text-sm sm:text-md max-w-sm mx-auto mt-8 text-blue-200 px-8 lg:px-0">
           We Are always looking for volounteers to help us grow and improve! Please reach out to us today!
          </div>
